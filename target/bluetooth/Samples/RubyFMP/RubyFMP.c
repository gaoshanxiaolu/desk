...
/*      All Rights Reserved.                                                  */
/*                                                                            */
/*  RUBYFMP - Ruby Bluetooth Find Me Profile using GATT (LE) application.     */
/*                                                                            */
/*  Author:  Cliff Xu                                                         */
/*                                                                            */
...
#include "RubyFMP.h"             /* Application Header.                       */
...
#define LE_DEMO_DEVICE_NAME                        "RubyFMP"
...
static void RubyFMP_entry(ULONG which_thread)
{
   int                      Result;
...
void user_main(void)
{
   ...
   tx_thread_create(&host_thread, "ruby fmp demo thread", RubyFMP_entry, 0, Ptr, PSEUDO_HOST_STACK_SIZE, 16, 16, 4, TX_AUTO_START);
