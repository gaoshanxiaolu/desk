...
//#endif
    ...
    void (*_qcom_set_dnscheck_reply_domainname(A_UINT8 check));
...
#define qcom_set_dnscheck_reply_domainname(check) \
           _qcom_set_dnscheck_reply_domainname(check)
#else  //AR6002_REV76
...
#define qcom_set_dnscheck_reply_domainname(check) \
           QCOM_NETWORK_API_FN(_qcom_set_dnscheck_reply_domainname(check))
