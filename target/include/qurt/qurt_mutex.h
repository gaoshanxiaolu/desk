...
/*=============================================================================
                        FUNCTIONS
=============================================================================*/
/**@ingroup func_qurt_mutex_create
  ...
  resource leaks, be sure to call qurt_mutex_delete() when this object is not used anymore.
...
/**@ingroup func_qurt_mutex_delete
...
/**@ingroup func_qurt_mutex_lock
  ...
  itself, however, the mutex does not become available to other threads until the thread 
  ...
  @caution1hang qurt_mutex_lock cannot be called from ISR context.
...
/**@ingroup func_qurt_mutex_lock_timed
  ...
  A thread is not suspended if it locks a recursive mutex that it has already locked by
  itself, however a mutex does not become available to other threads until the thread 
  performs a balanced number of unlocks on the mutex.
  ...
  @param[in]  timeout  How long a thread waits on the mutex before the wait is canceled. 
                         - #QURT_TIME_NO_WAIT - Return immediately without any waiting. \n
                         - #QURT_TIME_WAIT_FOREVER -- Equivalent to qurt_mutex_wait() \n
                         - Timeout value (in system ticks) -- Return after waiting for 
                           the specified time value. @tablebulletend
...
/**@ingroup func_qurt_mutex_try_lock
  ...
  For more information on this operation, see qurt_mutex_lock().
