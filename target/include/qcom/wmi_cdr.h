...
//#endif
  ...
  A_STATUS (*_CDR_wmi_ota_upgrade_cmd)(WMI_STRUCT_CDR * wmip,void *cmd);
    ...
    A_STATUS (*_CDR_wmi_specific_ie_enable_cmd)(WMI_STRUCT_CDR *wmip, A_UINT8 mgmt_frm_type, A_UINT8 ieee80211_elemid, A_UINT8 enable);
...
#define CDR_wmi_specific_ie_enable_cmd(wmip, mgmt_frm_type, ieee80211_elemid, enable)\
         _CDR_wmi_specific_ie_enable_cmd((wmip), (mgmt_frm_type), (ieee80211_elemid),(enable))
...
#define  CDR_wmi_set_vendor_specific_ie_cmd(wmip, mgmt_frm_type,ie_info,len)\
     WMI_CDR_API_FN(_CDR_wmi_set_vendor_specific_ie_cmd((wmip),(mgmt_frm_type),(ie_info),(len)))

#define CDR_wmi_specific_ie_enable_cmd(wmip, mgmt_frm_type, ieee80211_elemid, enable) \
    WMI_CDR_API_FN(_CDR_wmi_specific_ie_enable_cmd((wmip), (mgmt_frm_type), (ieee80211_elemid) ,(enable)))
