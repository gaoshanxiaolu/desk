...
/*      All Rights Reserved.                                                  */
/*                                                                            */
/*  RUBYTPS - Ruby Bluetooth Transmit Power Service using GATT (LE)           */
/*             application.                                                   */
/*                                                                            */
/*  Author:  Cliff Xu                                                         */
/*                                                                            */
...
#include "RubyTPS.h"             /* Application Header.                       */
...
#define LE_DEMO_DEVICE_NAME                        "RubyTPS"
...
static void RubyTPS_entry(ULONG which_thread)
{
   int                      Result;
...
void user_main(void)
{
   ...
   tx_thread_create(&host_thread, "ruby tps demo thread", RubyTPS_entry, 0, Ptr, PSEUDO_HOST_STACK_SIZE, 16, 16, 4, TX_AUTO_START);
