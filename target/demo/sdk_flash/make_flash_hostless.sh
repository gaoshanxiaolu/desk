...
# Golden image size : 988KB
# MODULE Partition size : 8k
# OTA Partition size : 1052KB
PARTITION_ENTRY_1=${PARTITION_ENTRY_1:-0x000F7000}
PARTITION_ENTRY_2=${PARTITION_ENTRY_2:-0x000F9000}
