...
//#endif
    ...
    A_STATUS (*_qcom_specific_ie_enable_cmd)(A_UINT8 device_id, A_UINT8 mgmt_frm_type, A_UINT8 ieee80211_elemid, A_UINT8 enable);
...
#define qcom_specific_ie_enable_cmd(device_id, mgmt_frm_type,  ieee80211_elemid, enable)\
    _qcom_specific_ie_enable_cmd((device_id), (mgmt_frm_type), (ieee80211_elemid), (enable))
...
#define qcom_specific_ie_enable_cmd(device_id, mgmt_frm_type, ieee80211_elemid, enable)\
        QCOM_CDR_API_FN(_qcom_specific_ie_enable_cmd((device_id), (mgmt_frm_type), (ieee80211_elemid), (enable)) 
