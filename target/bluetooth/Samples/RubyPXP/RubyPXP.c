...
/*      All Rights Reserved.                                                  */
/*                                                                            */
/*  RUBYPXP - Ruby Bluetooth Proximity Profile using GATT (LE) application.   */
/*                                                                            */
/*  Author:  Cliff Xu                                                         */
/*                                                                            */
...
#include "RubyPXP.h"             /* Application Header.                       */
...
#define LE_DEMO_DEVICE_NAME                        "RubyPXP"
      ...
      switch(GATT_Client_Event_Data->Event_Data_Type)
      {
         case etGATT_Client_Error_Response:
            if(GATT_Client_Event_Data->Event_Data.GATT_Request_Error_Data)
            {
               ...
               {
                  PRINTF("   Error Msg:       RACP Improperly Configured\n");
               }
               else
               {
...
static void RubyPXP_entry(ULONG which_thread)
{
   int                      Result;
...
void user_main(void)
{
   ...
   tx_thread_create(&host_thread, "ruby pxp demo thread", RubyPXP_entry, 0, Ptr, PSEUDO_HOST_STACK_SIZE, 16, 16, 4, TX_AUTO_START);
