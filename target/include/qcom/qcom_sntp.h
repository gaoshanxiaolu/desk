...
typedef enum {
    SNTP_SYNC_ONE_SHOT = 0,               /* SNTP SYNC one time */
    SNTP_SYNC_PERIODIC,                   /* SNTP SYNC periodicly */
}SNTP_SYNC_TYPE;
...
A_STATUS (*_qcom_sntp_sync_start)( SNTP_SYNC_TYPE type, A_UINT32 mseconds);
void (*_qcom_sntp_sync_stop)();
#endif
...
#define qcom_sntp_sync_start(type, mseconds)  \
   _qcom_sntp_sync_start((type), (mseconds))

#define qcom_sntp_sync_stop()  \
   _qcom_sntp_sync_stop()

#else
#define qcom_sntp_sync_start(type, mseconds)  \
   QCOM_SNTP_API_FN(qcom_sntp_sync_start((type), (mseconds)))

#define qcom_sntp_sync_stop()  \
   QCOM_SNTP_API_FN(_qcom_sntp_sync_stop())
