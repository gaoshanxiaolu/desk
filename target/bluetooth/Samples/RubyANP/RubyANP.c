...
/*      All Rights Reserved.                                                  */
/*                                                                            */
/*  RUBYANP - Ruby Bluetooth Alert Notification Profile using GATT (LE)       */
/*             application.                                                   */
/*                                                                            */
/*  Author:  Cliff Xu                                                         */
/*                                                                            */
...
#include "RubyANP.h"             /* Application Header.                       */
...
#define LE_DEMO_DEVICE_NAME                        "RubyANP"
            ...
            if(GATT_Client_Event_Data->Event_Data.GATT_Request_Error_Data)
            {
               ...
               if(GATT_Client_Event_Data->Event_Data.GATT_Request_Error_Data->ErrorType == retErrorResponse)
               {
                  ...
                  else
                  {
                     ...
                     {
                        PRINTF("Error Msg:       Not Supported.\n");
                     }
                     else
...
static void RubyANP_entry(ULONG which_thread)
{
   int                      Result;
...
void user_main(void)
{
   ...
   tx_thread_create(&host_thread, "ruby anp demo thread", RubyANP_entry, 0, Ptr, PSEUDO_HOST_STACK_SIZE, 16, 16, 4, TX_AUTO_START);
