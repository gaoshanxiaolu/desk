...
#define AWS_IOT_MQTT_CLIENT_ID         "387264428830" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 		   "Mp1_2" ///< Thing Name of the Shadow this device is associated with
